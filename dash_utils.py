...
def load_data(
    ...
    if cntx.view.get_code() in [view_def.mode_ts, view_def.mode_tbl]:
        p = get_d_data(cntx) + "<view_code>/<varidx_code>.csv"
    elif cntx.view.get_code() == view_def.mode_map:
        p = get_d_data(cntx) + "<view_code>/<varidx_code>/<hor_code>/*_<rcp_code>_*_<stat>_<delta>.csv"
    elif cntx.view.get_code() == view_def.mode_cycle:
        p = get_d_data(cntx) + "<view_code>/<varidx_code>/<hor_code>/*<model_code>*<rcp_code>*.csv"
